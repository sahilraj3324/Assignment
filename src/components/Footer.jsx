...
const Footer = () => {
  return (
    <div className='bg-[] font-abc md:px-14 p-4 max-w-screen-2xl mx-auto text-grey '>
    <div className='my-12 flex flex-col md:flex-row gap--1'>
         <div className="md:w-1/2 space-y-8">
            <a href="/" className='text-2xl font-semibold flex items-center space-x-3  '>
              <img src={logo}  alt="" className='w-10 inline-block items-center pointer'/>
              <span className='' >AniWorld </span>
          </a>
